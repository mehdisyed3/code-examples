...
function rot13(str) {
  ...
  for (var i = 0; i < word.length; i++) { // iterating througj each element of word
    ...
    if (cIndex === -1) { // this basecase will allow all other character to be pushed w/o any change
      final.push(word[i])
    }

    if (cIndex <= 12 && cIndex >= 0) { // this basecase will allow all other character to be pushed w/o any change
